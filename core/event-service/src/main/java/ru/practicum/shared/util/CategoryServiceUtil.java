...
public class CategoryServiceUtil {
    ...
    public ResponseCategoryDto getResponseCategoryDto(CategoryRepository categoryRepository, CategoryMapper categoryMapper, Long categoryId) {
        return categoryRepository.findById(categoryId)
                .map(categoryMapper::toCategoryDto)
                .orElseThrow(() -> new NotFoundException("Category with id=" + categoryId + " was not found"));
    }

    public Map<Long, ResponseCategoryDto> getResponseCategoryDtoMap(CategoryRepository categoryRepository, CategoryMapper categoryMapper, Set<Long> categoriesIds) {
